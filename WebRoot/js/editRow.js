	function insertRow(){
	    ...
	    newTd2.innerHTML = "<input class='ipt_s'size='30' type='text' id='attaname"+sizes+"' name='attanames' />  <input class='input_text' type='text' id='txt"+sizes+"' readonly/>&nbsp;&nbsp;<input type='button' value='上传...' class='btn_select' /><input class='input_file' size='30' type='file' name='attafiles' onchange='setFileName(this.value,"+sizes+");'/>";

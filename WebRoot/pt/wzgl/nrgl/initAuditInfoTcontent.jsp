...
<dl class="mtab" style="margin-top:3px;">
	<dd>
		...
		<iframe id="infoTcontentFrame" name="infoTcontentFrame" onload="setWinHeight()" src="queryAuditInfoTcontentList.action?columnId=<s:property value='columnId'/>" frameborder="0" style="float:left;display:inline;width:78%;"></iframe>
	</dd>
</dl>
</body>
</html>

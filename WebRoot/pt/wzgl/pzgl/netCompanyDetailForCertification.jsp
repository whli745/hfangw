...
<head>
	...
	<!-- 常用JS -->
	<script type="text/javascript" src="<%=basePath%>zwdt/js/common.js"></script>
	<script type="text/javascript">
		//打开审核页面 
		function openShenhe(id,userId){
			jQuery.layer({
				type : 2,
				closeBtn: [0, true],
				shade : [ 0.1, '#000' ],
				...
				shadeClose : false,
				iframe : {
					src : "netCompanyDetailForAudit.action?ucId="+id+"&ids="+userId
				},
				area : ['500px', '300px'],
					...
					<s:iterator value="certificates" status="st">
						<tr>
							...
							<td>
								...
								<s:else>
									<a href="javascript:openShenhe('<s:property value="id" />','<s:property value='ids' />');">审核</a>
								</s:else>
							</td>
						</tr>
					</s:iterator>

function LoginDialog(option, regster_data) {
    ...
    function Login() {
        ...
        function submitHandler() {
            ...
            USERNAME.success && PWD.success && (global.loginDailog.callbackLoginSuccess = function(ret) {
                ret.error == "402" && (codeDom_info.html("\u9a8c\u8bc1\u7801\u4e0d\u80fd\u4e3a\u7a7a").show(), codeBox.show()),
                ret.error == "403" && (codeDom_img.attr("src", opts.memberDomain + "/captcha?r=" + Math.random()), codeDom_info.html("\u9a8c\u8bc1\u7801\u4e0d\u6b63\u786e").show(), codeBox.show());
                if (!ret.result) {
                    var data = ret.data;
                    if (data) {
                        var userid = data.USERID,
                        usertype = data.USERTYPE;
                        typeof customEvent.callback == "string" ? eval(customEvent.callback) : customEvent.callback(data),
                        objDialog.close(),
                        loginObj && loginObj.refresh()
                    }
                } else USERNAME.dom.next().hide(),
                PWD.dom.next().hide(),
        ...
        var USERNAME, PWD, CODE, saveUsername, codeBox = J.g("codeBox"),
    ...
    function Register() {
        function Stack(e) {
            ...
            function o(e) {
                var n = 0,
                r = t.length;
                for (; n < r; n++) t[n] === e && (delete t[n], t.splice(n, 1));
                return ! 1
            }
            function u(e) {
            ...
            if (submitType == "mail") {
                        ...
                        if (e.code == -1) {
                            ...
                            stack.unShift(function() {
                                ...
                                return e ? (stack.unShift(function(e) {
                                    ...
                                    return t.html("\u9a8c\u8bc1\u7801\u4e0d\u6b63\u786e").show(),
                                    cRegister.s(".li_code").eq(0).s("img").eq(0).attr("src", opts.imgMailCode.replace(/(?:r=).*/, "r=" + Math.random())),
                                    !1
                                }), J.get({
                                    type: "jsonp",
                                    url: opts.validateSuccessMail,
                ...
                stack.push(function() {
                    return postJSONP({
                        type: "jsonp",
                        data: data,
                        callback: "window.parent.global.loginDailog.callbackRegisterSuccess",
                        url: opts.memberDomain + "/register"
                    }),
                    !1
                }),
                stack.run();
        ...
        function getPosition(e, t) {
            ...
            if (!t) r.position == "absolute" ? (n.x = e.offsetLeft - (parseInt(r.marginLeft) || 0), n.y = e.offsetTop - (parseInt(r.marginTop) || 0)) : r.position == "relative" && (n.x = parseInt(r.left) || 0, n.y = parseInt(r.top) || 0);
                ...
                for (var i = e; i.offsetParent && i != t; i = i.offsetParent) n.x += i.offsetLeft,
                n.y += i.offsetTop;
        ...
        function UserName() {
            ...
            var e = eleUseName,
            t, n, r = J.g("info_userName").hide(),
            i = /^1[3|4|5|8][0-9]\d{4,8}$/,
            ...
            e.autocomplete({
                ...
                onBlur: function(t) {
                    ...
                    function() {
                        l(),
                        submitType == "mail" && (J.g("b_mail").show(), J.g("b_tel").hide(), global.loginDailog.callbackMailValidate = c, J.get({
                            type: "jsonp",
                            url: opts.userDomain + "/register",
                            data: {
                                chktype: "email",
                ...
                onSelect: function(t) {
                    ...
                    if (submitType == "mail") {
                        ...
                        r.s("label").eq(0).html("\u9a8c\u8bc1\u7801\uff1a"),
                        global.loginDailog.callbackMailValidate = c,
                        J.get({
                            type: "jsonp",
                            url: opts.userDomain + "/register",
                            data: {
        ...
        function ImgCode() {
            function i(n) {
                ...
                s = n.msg;
                200 === i ? (t.html(""), t.hide(), e.next().next().next().show(), "tel" === submitType && r.show()) : 201 === i && (t.attr("class", "v_error"), t.html(s), r.hide()),
                t.show()
            }
            ...
            function() {
                e.val().length > 0 ? (t.hide(), J.get({
                    type: "jsonp",
                    url: opts.memberDomain + "/checkcaptcha/",
                    data: {
                        captcha: J.g("b_mail").s("input").eq(0).val(),
                        callback: "global.loginDailog.verifyCaptcha"
                    }
            ...
            function s() {
                ...
                J.get({
                    ...
                    data: {
                        ...
                        r: Math.random(),
                        phone: J.g("iptUserName").val(),
                        referer: opts.history,
                        captcha_user_id: J.getCookie("ajk_member_captcha"),
    ...
    var defOptions = {
        ...
        memberDomain: "http://member.anjuke.com",
        userDomain: "http://user.anjuke.com",
        QQ: "http://member.anjuke.com",
        weibo: "http://member.anjuke.com",
        base64UrlLogin: "aHR0cDovL3NoYW5naGFpLnJlbGVhc2UubHVuamlhbmcuZGV2LmFuanVrZS5jb20vYWNjb3VudC9sb2dpbnN1Y2Nlc3Mv",
    ...
    defData = {
        ...
        opts.validateSuccessMail = opts.memberDomain + "/member/1.0/code",
        opts.imgMailCode = opts.memberDomain + "/captcha?r=" + Math.random(),
        optsData = J.mix(defData, regster_data),
        function() {}.require([], ["ui.panel_login"], !0)
    })();
    var html, tabLogin, tabRegister, LOGIN, REGISTER, isLogin, isRegister, cLogin, cRegister;
    return {
        showLogin: showLogin,
    ...
    function V(e, t) {
        ...
        } else for (; n < i;) if (t.call(e[n], n, e[n++]) === !1) {
            o = !1;
            break
        }
        return o
    ...
    function st() {
        ...
        function s(e) {
            return (e = e.toString().match(/^(.*)[\S\s]*\{/)) ? e[1] : ""
        }
    ...
    u = "http://include.aifcdn.com/ujs/",
    a = "http://include.aifcdn.com/ucss/",
    f = {},
    l = {
        PS: n,
        BS: t,
    ...
    c = "b34af0157d629e6e4743e831e5547cfe",
    h = [],
    p = [],
    d = [],
    v = [],
...
function(J) {
    ...
    function v(e, t) {
        ...
        var r = "?tp=error&site=" + f + "&v=" + (J.W.PHPVERSION || "") + "&msg=" + n; (new Image).src = o + r,
    ...
    var c = J.logger,
    h = ["Player", "baiduboxapphomepagetag", "onTouchMoveInPage"];
...
try {
    ...
    n.Tracker = function(r, i, s) {
        function f() {
            var n = {
                p: o.page,
                h: o.href || t.location.href,
                r: o.referrer || t.referrer || "",
                sc: o.screen || '{"w":"' + e.screen.width + '"' + ',"h":"' + e.screen.height + '"' + ',"r":"' + (e.devicePixelRatio >= 2 ? 1 : 0) + '"' + "}",
                site: o.site || "",
                guid: u(o.nGuid || "aQQ_ajkguid") || "",
                ctid: u(o.nCtid || "ctid") || "",
                luid: u(o.nLiu || "lui") || "",
                ssid: u(o.nSessid || "sessid") || "",
                uid: s || u(o.nUid || "ajk_member_id") || "0",
                t: +(new Date)
            };
            return o.method && (n.m = o.method),
            o.cst && /[0-9]{13}/.test(o.cst) && (n.lt = n.t - parseInt(o.cst)),
            o.pageName && (n.pn = o.pageName),
            o.customParam && (n.cp = o.customParam),
            n
        }
        function l(e) {
            var t = f(),
...
function(J, e, t) {
    ...
    function s(e) {
        var t = 0,
        n = this.length;
        for (; t < n;) if (e.call(o(this[t]), t, o(this[t++])) === !1) break;
        return this
    }
    function o(e) {
        var t = new l(e);
    ...
    function f(e) {
        for (var t in r)(function(t) {
            t !== "length" && t !== "get" && t !== "eq" && t !== "s" && t !== "each" && (e[t] = function() {
                ...
                s = n,
                u = !1;
                for (; r < i;) s = o(e[r])[t].apply(e[r++], arguments),
                s && (u = s);
    ...
    function E(e, t, n) {
        for (var r = e.get()[n]; r; r = r[t]) if (r.nodeType == 1) return o(r)
    }
    function S(e, t, n) {
        for (var r = e.get()[n]; r; r = r[t]) if (r.nodeType == 1) return o(r);
        return a(e)
    ...
    function N(e, n) {
        ...
        var r = e ? e.match(/^(\.)?([a-zA-Z0-9_-]+)(\s([a-zA-Z0-9_-]+))?/) : null,
        i = [],
        s,
        o,
        u,
    ...
    function C(e, t) {
        var n = e.length,
        r, i = 0;
        for (r = t.length; i < r; i++) e[n++] = o(t[i]);
        e.length = n
    }
    var n = J.undef,
    r = {
        ...
        getStyle: function(e) {
            ...
            e = e == d ? v: e;
            var i = n.style[e];
            if (!i || i == "auto") J.ua.ie ? r = n.currentStyle: r = t.defaultView.getComputedStyle(n, null),
            i = r ? r[e] : null;
        ...
        append: function(e) {
        	if(typeof e.get() == 'undefined')return;
...
function(e, t, n) {
    function r(e, t, n, r) {
        var i = 0,
        s = t.length;
        for (; i < s; i++) it(e, t[i], n, r)
    }
    function i(e, t, n, i, s, o) {
        var u, a = st.setFilters[t.toLowerCase()];
        return a || it.error(t),
        (e || !(u = s)) && r(e || "*", i, u = [], s),
        u.length > 0 ? a(u, n, o) : []
    }
    function s(e, t, s, o, u) {
        var a, f, l, c, h, p, d, v, m = 0,
        g = u.length,
        y = X.POS,
    ...
    function f(e, t, n) {
        var r, i, s = 0;
        for (; r = e[s]; s++) st.relative[r.part] ? i = u(i, st.relative[r.part], t) : (r.captures.push(t, n), i = a(i, st.filter[r.part].apply(null, r.captures)));
        return i
    }
    function l(e) {
        return function(t, n) {
            var r, i = 0;
            for (; r = e[i]; i++) if (r(t, n)) return ! 0;
            return ! 1
        }
    }
    var c, h, p, d, v, m = e.document,
    g = m.documentElement,
    y = "undefined",
    b = !1,
    w = !0,
    ...
    it = function(e, t, n, r) {
        ...
        if (!o && !r) if (i = I.exec(e)) if (u = i[1]) {
            if (a === 9) {
                ...
                n
            } else if (t.ownerDocument && (s = t.ownerDocument.getElementById(u)) && at(t, s) && s.id === u) return n.push(s),
            n
        } else {
            if (i[2]) return x.apply(n, S.call(t.getElementsByTagName(e), 0)),
            n;
            if ((u = i[3]) && rt && t.getElementsByClassName) return x.apply(n, S.call(t.getElementsByClassName(u), 0)),
            n
        }
        return ct(e, t, n, r, o)
    },
    st = it.selectors = {
        ...
        preFilter: {
            ...
            CHILD: function(e) {
                ...
                e[1] === "nth" ? (e[2] || it.error(e[0]), e[3] = +(e[3] ? e[4] + (e[5] || 1) : 2 * (e[2] === "even" || e[2] === "odd")), e[4] = +(e[6] + e[7] || e[2] === "odd")) : e[2] && it.error(e[0]),
                e
            },
            PSEUDO: function(e) {
                var t, n = e[4];
        ...
        filter: {
            ...
            CLASS: function(e) {
                var t = V[e];
                return t || (t = V[e] = new RegExp("(^|" + N + ")" + e + "(" + N + "|$)"), $.push(e), $.length > st.cacheLength && delete V[$.shift()]),
                function(e) {
            ...
            PSEUDO: function(e, t, n, r) {
                ...
                return i || it.error("unsupported pseudo: " + e),
    ...
    st.setFilters.nth = st.setFilters.eq,
    st.filters = st.pseudos,
    nt || (st.attrHandle = {
        href: function(e) {
    ...
    at = it.contains = g.compareDocumentPosition ?
    function(e, t) {
    ...
    ft = it.getText = function(e) {
        ...
        if (i) {
            if (i === 1 || i === 9 || i === 11) {
                ...
                for (e = e.firstChild; e; e = e.nextSibling) n += ft(e)
            } else if (i === 3 || i === 4) return e.nodeValue
        } else for (; t = e[r]; r++) n += ft(t);
        return n
    };
    it.attr = function(e, t) {
        var n, r = ut(e);
        return r || (t = t.toLowerCase()),
        st.attrHandle[t] ? st.attrHandle[t](e) : et || r ? e.getAttribute(t) : (n = e.getAttributeNode(t), n ? typeof e[t] == "boolean" ? e[t] ? t: null: n.specified ? n.value: null: null)
    },
    it.error = function(e) {
    ...
    g.compareDocumentPosition ? p = function(e, t) {
        ...
        n = i.length,
        r = s.length;
        for (var f = 0; f < n && f < r; f++) if (i[f] !== s[f]) return d(i[f], s[f]);
    ...
    it.uniqueSort = function(e) {
        ...
        if (p) {
            b = w,
            e.sort(p);
            if (b) for (; t = e[n]; n++) t === e[n - 1] && e.splice(n--, 1)
        }
        return e
    };
    var lt = it.compile = function(e, t, n) {
        ...
        i = o(e, t, n);
        for (s = 0; r = i[s]; s++) i[s] = f(r, t, n);
        return u = J[e] = l(i),
        u.context = t,
        u.runs = u.dirruns = 0,
        K.push(e),
        K.length > st.cacheLength && delete J[K.shift()],
        u
    };
    ...
    var ct = function(e, t, n, r, i) {
        e = e.replace(P, "$1");
        var o, u, a, f, l, p, d, v, m, g = e.match(B),
        y = e.match(F),
        b = t.nodeType;
        ...
        if (r) o = S.call(r, 0);
            ...
            v = (g = q.exec(y[0])) && !g.index && t.parentNode || t,
            m = y.pop(),
            p = m.split(":not")[0];
            for (a = 0, f = st.order.length; a < f; a++) {
                d = st.order[a];
                if (g = X[d].exec(p)) {
        ...
        if (e) {
            u = lt(e, t, i),
            h = u.dirruns++,
            o == null && (o = st.find.TAG("*", q.test(e) && t.parentNode || t));
            for (a = 0; l = o[a]; a++) c = u.runs++,
            u(l, t) && n.push(l)
        }
        return n
    };
...
function(J) {
    function i(i) {
        ...
        function A(e, t) {
            return J.create("div", t || {}).insertFirstTo(e)
        }
        function O(e, t, n) {
        ...
        function H(e) {
            e ? w.addClass(p + "_ok_disable") : w.removeClass(p + "_ok_disable"),
            b = e
        }
        var s, o, u, a, f, l, c, h, p, d = J.page,
        v, m, g = "0 0",
        y = "0 0",
        b = !1,
        w, E, S = d.width(),
...
function(J, e) {
    function n(n, r) {
        ...
        function A(e) {
            ...
            if (y) return; ! n.val().trim() && !c.allowEmpty && K(),
            clearTimeout(g),
        ...
        function F(e, t) {
            ...
            function(e, n) {
                ...
                i == a && (o = e),
                f ? (S++, n.l && (r = J.create("p", {
                    "class": "ui_item"
                }).html(n.l).appendTo(m).on("click",
                function(e) {
                    e && e.stop()
        ...
        function W() {
            ...
            y = !0,
            d.each(function(e, t) {
                if (t.hasClass("ui_sel")) return t.removeClass("ui_sel"),
                !1
            }),
            n.val(a = U((e = d.eq(++u).addClass("ui_sel")).html())),
            X(u)
        ...
        return function() {
            ...
            c.width || (c.width = c.parentWidth ? c.parentWidth: s.width() - 2),
...
function(J) {
    function Exposure(options) {
        ...
        var opts, disPatch, tasker, traceTag, page = J.page,
        tracker; (function() {
...
function(J, e) {
    function t(e) {
        ...
        function S(e) {
            ...
            var r = l + c - t,
            i = n.data[r];
            f[c].style.visibility = i ? (f[c].innerHTML = m(i, r), "visible") : "hidden",
            c++;
            if (c >= t) {
                u.onclick = S,
                c = 0,
        ...
        function x(e) {
            ...
            var i = t + l + h,
            s = n.data[i];
            f[h].style.visibility = s ? (f[h].innerHTML = m(s, i), "visible") : "hidden",
            h--;
            if (h < 0) {
                h = t - 1,
                l += t,
        ...
        p; (function() {
            n = J.mix(t, e),
            i = '<div class="ajax_prop"><div style="margin-top:10px;font: bold 16px/40px \u5b8b\u4f53">' + n.title + '</div> <div class="list_c"><ul class="clearfix">',
            h = n.items - 1,
            r = J.g(n.id);
            if (!r) {
            ...
            a = r.s("a").eq(1).get();
            if (n.data.length >= n.items) {
                n.data.length === n.items && (u.style.display = "none", a.style.display = "none"),
                v(u, a),
                E(),
                f = r.get().getElementsByTagName("li");
                var l = [];
                l.push(0);
                for (var c = 0; c < n.data.length; c++)(function(e) {
                    var t = new Image;
                    t.onload = function() {},
...
function(J, e) {
    function t(e) {
        ...
        function c(e) {
            ...
            var r = '<div class="login_info">' + d(e.msgCount) + '<div class="l" id="login_l"><div class="m"><a href="' + e.my_anjuke + '" class="usr">' + e.userName + "</a>" + '<span class="up_down_usr"></span></div><div class="o_b" style="display: none;"><ul>' + '<li><a href="' + e.msgUrl + '">\u6211\u7684\u6d88\u606f' + t + "</a></li>" + '<li class="sep"></li>' + '<li><a href="' + e.myanjuke + '">\u4e2d\u56fd\u7f51\u7edc\u7ecf\u7eaa\u4eba</a></li>' + n + '<li class="sep"></li>' + '<li class="exit"><a class="exit" href="' + e.exit + '">\u9000\u51fa</a></li>' + "</ul></div>  " + "</div>" + u + "</div>",
            i = '<a class="u" href="' + e.myanjuke + '">\u4e2d\u56fd\u7f51\u7edc\u7ecf\u7eaa\u4eba</a>' + (e.developUrl ? '<a class="u" href="' + e.developUrl + '">\u65b0\u623f\u5206\u9500\u5e73\u53f0</a>': "");
            p(r, i)
        }
        function h(e) {
            var t = v(e.msgCount),
            n = e.fytUrl ? '<li><a href="' + e.fytUrl + '">\u623f\u6613\u901a</a></li>': "",
            r = e.developUrl ? '<li><a href="' + e.developUrl + '">\u65b0\u623f\u5206\u9500\u5e73\u53f0</a></li>': "";
            ...
            s = (e.fytUrl ? '<a class="u" href="' + e.fytUrl + '">\u623f\u6613\u901a</a>': "") + (e.developUrl ? '<a class="u" href="' + e.developUrl + '">\u65b0\u623f\u5206\u9500\u5e73\u53f0</a>': "");
            p(i, s)
        }
        function p(e, t) {
            r.length && r.html(e),
        ...
        function d(e) {
            e *= 1;
            var t = e > 0 ? e > 99 ? "25": e > 9 ? "19": "14": 0,
            n = e > 0 ? e > 99 ? "99+": e: 0,
            r = e > 0 ? '<span class="tip_d" style="width:' + t + 'px">' + n + "</span>": '<span class="tip_d"></span>';
            return r
        }
        function v(e) {
            var t = e,
        ...
        function m() {
            var e = r.s(".o_b").eq(0);
            e.length && J.g("login_l").on("mouseenter",
            function() {
            ...
            J.g("login_r") && J.g("login_r").on("click",
            function() {
            ...
            n && n.on("click",
            function() {
                var e = t + "ajax/usersetting/?key=shutNotify&value=1&_r=" + Math.random(); (new Image).src = e,
                n.up(0).remove()
            });
            var i = n && n.prev();
            i && i.on("click",
            function() {
                var e = i.attr("url"),
                r = t + "ajax/usersetting/?key=viewNotify&value=1&callback=url_callback&url=" + encodeURIComponent(e) + "&_r=" + Math.random();
                n.up(0).remove();
        ...
        function g() {
            return J.get({
                url: t + "ajax/checklogin/" + "?r=" + Math.random(),
                type: "jsonp",
        ...
        function y(e) {
            ...
            if (e.common.userid > 0) {
                ...
                if (n == 1 || n == 9 || n == 10) {
                    var r = {
                        my_anjuke: e.righturl.myanjuke,
                        showNotiy: !parseInt(e.shutNotify),
                        isExpert: e.qamember.cons > -1 || 0,
                        isMananer: e.qamember.admin || !1,
                        msgCount: e.common.totalUnreadCount,
                        userName: e.common.usernamestr ? e.common.usernamestr.length > 5 ? e.common.usernamestr.slice(0, 4) + "...": e.common.usernamestr: "",
                        my_favorite: e.righturl.links.my_favorite,
                        my_recommend: e.righturl.links.my_recommend,
                        view_history: e.righturl.links.view_history,
                        subscription_management: e.righturl.links.subscription_management,
                        my_ask: e.righturl.links.my_ask,
                        my_ugc: e.righturl.links.my_ugc,
                        my_msg: e.lefturl.pmurl,
                        qa_url: e.lefturl.qaurl,
                        msg_title: e.lefturl.title,
                        publish_sell: e.righturl.links.publish_sell || "#",
                        publish_rent: e.righturl.links.publish_rent || "#",
                        publish_shop: e.righturl.links.publish_shop || "#",
                        exit: e.lefturl.logouturl,
                        expert_home: e.righturl.links.expert_home || "#",
                        ask_center: e.righturl.links.ask_center || "#",
                        my_house: e.common.my_house || "#"
                    };
                    this.my_favorite = r.my_favorite,
                    t = l(r)
                } else if (n == 2) {
                    var e = {
                        userName: e.common.usernamestr ? e.common.usernamestr.slice(0, 5) : "",
                        exit: e.lefturl.logouturl || "#",
                        myanjuke: e.righturl.myanjuke || "#",
                        msgUrl: e.lefturl.pmurl || "#",
                        msgCount: e.common.totalUnreadCount,
                        my_house: e.common.my_house || "#",
                        developUrl: e.common.developUrl || !1
                    };
                    t = c(e)
                } else if (n == 8) {
                    var e = {
                        userName: e.common.usernamestr ? e.common.usernamestr.slice(0, 5) : "",
                        exit: e.lefturl.logouturl || "#",
                        myanjuke: e.righturl.links.fang_anjuke || "#",
                        msgUrl: e.lefturl.pmurl || "#",
                        msgCount: e.common.totalUnreadCount,
                        fytUrl: e.common.fytUrl || !1,
                        developUrl: e.common.developUrl || !1
                    };
                    t = h(e)
                }
        ...
        function b(e) {
            e.each(function(e, t) {
                t.un("mouseenter"),
                t.un("mouseleave"),
                t.s("a").each(function(e, n) {
                    t.un("click")
                })
            })
        }
        var t = e.baseUrl || "",
        n, r, i = e.showSimple || !1,
        s = !1,
        o = "",
        u = "";
        return J.ready(a),
    ...
    function n(e) {
        var e = e.replace(/\?(.*)/, "");
        return ! /\.anjuke\.(com|test)\/(community|ask)\/(view|props|trends|photos|photos2|round|qa|duibi)/.test(e) && !/\.(zu|xzl|sp)(\.dev)?.anjuke\.(com|test)\/((g)?fangyuan|zu|shou|xinpan)(\/(xiangce|jiaotong|canshu))?\/(\d*)/.test(e) && !/\.anjuke\.(com|test)\/(school|baike)\/(\d+)/.test(e) && !/\.anjuke\.(com|test)\/rent/.test(e) && (/\.(fang|zu|chat|xzl|sp)(\.dev)?.anjuke.(com|test)/.test(e) || /\.anjuke\.(com|test)\/(sale|list|school|community|tycoon|maifang|gujia|ask|baike|act|topic)/.test(e))
    }
    J.site.isList = n(window.location.href),
    J.site.isList ||
    function() {}.require([""], "ui.login", !0),
    J.ui.login = t
} (J, document),
function(J, e) {
    function t(e) {
        ...
        function c(e) {
            ...
            n = e.developUrl ? '<li><a href="' + e.developUrl + '">\u65b0\u623f\u5206\u9500\u5e73\u53f0</a></li>': "";
            e.my_anjuke = "http://my.anjuke.com/user/broker/brokerhome";
            var r = '<div class="login_info">' + d(e.msgCount) + '<div class="dropdown broker-login" id="login_l">' + '<div class="title m">' + '<span class="name">\u60a8\u597d\uff0c' + e.userName + '</span><a class="exit ie6" href="' + e.exit + '">[\u9000\u51fa]</a>' + '<a class="ie6" href="' + e.msgUrl + '"><span class="text">\u6d88\u606f</span>' + t + "</a>" + "</div>" + "</div>" + '<div class="dropdown menu ' + (e.developUrl ? "": "last-child") + '"><div class="title"><a class="u" href="' + e.myanjuke + '">\u4e2d\u56fd\u7f51\u7edc\u7ecf\u7eaa\u4eba</a></div></div>' + (e.developUrl ? '<div class="dropdown menu last-child"><div class="title"><a class="u" href="' + e.developUrl + '">\u65b0\u623f\u5206\u9500\u5e73\u53f0</a></div></div>': "") + "</div>";
            p(r)
        }
        function h(e) {
            var t = v(e.msgCount),
        ...
        function m() {
            ...
            function() {
                var e = o.attr("url"),
                n = t + "ajax/usersetting/?key=viewNotify&value=1&callback=url_callback&url=" + encodeURIComponent(e) + "&_r=" + Math.random();
                s.up(0).remove();
    ...
    J.site.isList &&
    function() {}.require([""], "ui.loginNew", !0),
    J.ui.loginNew = t
} (J, document),
function(e) {
    "use strict";
...
function() {
    ...
    function S() {
        var e = ["anjuke.com", "anjuke.test", "2345.com", "rising.cn", "hao123.com", "uc123.com"];
    ...
    J.logger.onError = function(e) { / test / .test(i) && alert(decodeURIComponent((e + "").replace(/,/g, "\n")))
    },
...
function() {
    ...
    J.utils.base = {
        encode: function(e) {
            ...
            f = (s & 15) << 2 | o >> 6,
            l = o & 63,
            isNaN(s) ? f = l = 64 : isNaN(o) && (l = 64),
            r = r + n.charAt(u) + n.charAt(a) + n.charAt(f) + n.charAt(l);
            return r
        },
        decode: function(t) {
            var i = "",

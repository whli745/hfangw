...
function init(uploadLimit,sizeLimit){
	...
	var uploadbody='<div id="uploadBody" class="ke-dialog-upload">'
		...
		+'	</div>'
		+' <div id="maskDiv" style="display: block; width: 100%; height: 100%; position: absolute; left: 0px; top: 0px; z-index: 811212;" class="ke-dialog-mask"></div>';
	$('body').append(uploadbody);
	var e = e || window.event;
	$("#uploadBody").css({"left":e.clientX + "px", "top":($(window).scrollTop()+20) + "px"});
	$("#maskDiv").height(($(window).scrollTop()+20)+450 );
